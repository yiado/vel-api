...
<tr>
    <td width="100%">
		...
		<tr>
		    <td width="15%"><strong>Ruta en IGEO</strong> </td>
		    <td width="85%" colspan="3">: <?=$wo['node_ruta']; ?></td>    
		</tr>
		<tr>
		    <td width="15%"><strong>Nombre de Recinto</strong> </td>
		    <td width="35%">: <?=$wo['node_name']; ?></td>    
		    <td width="15%"><strong>Tipo</strong></td>
		    <td width="35%">: <?=$wo['node_type_name']; ?></td>
		</tr>
		<tr>
		    <td width="15%"><strong>Proveedor</strong> </td>
		    <td width="35%">: <?=$wo['Provider']['provider_name']; ?></td>    
		    <td width="15%"><strong>Fecha</strong></td>
		    <td width="35%">: <?=$wo['fecha']; ?></td>
		</tr>
		<tr>
...
<tr>
  <td width="20%"><div align="center"><strong>Nombre Tarea</strong></div></td>
  <td width="15%"><div align="center"><strong>Precio</strong></div></td>
  <td width="15%"><div align="center"><strong>Insumo</strong></div></td>
  <td width="50%"><div align="center"><strong>Comentario</strong></div></td>
  </tr>
...
<table width="100%" border="1" cellpadding="2" cellspacing="0">
  <tr>
    <td colspan="3" bgcolor="#cccccc"><div align="center"><strong>Costos Directos</strong></div></td>
  </tr>
	<tr>
	  <td width="60%"><div align="center"><strong>Nombre Costo Directo</strong></div></td>
	  <td width="20%"><div align="center"><strong>Valor</strong></div></td>
	  <td width="20%"><div align="center"><strong>Porcentaje</strong></div></td>
  </tr>
...
<tr>
  ...
  <td align="center"><?php echo $other_list_reg['mtn_work_order_other_costs_comment'] . " %";?></td>
  </tr>
<?php endforeach;?>
</table>
...
<tr>
    <td>
		...
		<tr>
		    <td align="left"><strong>Total Tareas         </strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;<?= "$ " . number_format($wo['total_task'], $currency_format->currency_number_of_decimal, $currency_format->currency_decimal_character, $currency_format->currency_thousands_character); ?></td>
		</tr>
		<tr>
		    <td align="left"><strong>Total Costos Directos   </strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;<?="$ " . number_format($wo['total_other_costs'], $currency_format->currency_number_of_decimal, $currency_format->currency_decimal_character, $currency_format->currency_thousands_character); ?></td>
		</tr>
		<tr>
		    <td align="left"><strong>Total Orden Trabajo  </strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;<?="$ " . number_format($wo['total_work_order'], $currency_format->currency_number_of_decimal, $currency_format->currency_decimal_character, $currency_format->currency_thousands_character); ?></td>
		  </tr>
                  <tr>
		    <td align="left"><strong>Total Orden Trabajo + I.V.A </strong> : &nbsp;&nbsp;<?="$ " . number_format($wo['total_work_order_iva'], $currency_format->currency_number_of_decimal, $currency_format->currency_decimal_character, $currency_format->currency_thousands_character); ?></td>
		  </tr>
		</table>
	</td>    
  </tr>
