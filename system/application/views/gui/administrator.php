...
?>
        ...
        <?php if (!empty($modules['Infrastructure'])) : ?>
        ...
        <?php if (!empty($modules['Maintenance'])) : ?>
        ...
        <?php if (!empty($modules['Request'])) : ?>
            <script type="text/javascript" src="<?= base_url(); ?>javascript/application/request/base_solicitudes.js"></script>
            <script type="text/javascript" src="<?= base_url(); ?>javascript/application/request/store_solicitudes.js"></script>
            <script type="text/javascript" src="<?= base_url(); ?>javascript/application/maintainers/interface_solicitudes.js"></script>
        <?php endif; ?>

        <?php if (!empty($modules['Costs'])) : ?>
        ...
        <?php if (!empty($modules['InfraMaintenance'])) : ?>
