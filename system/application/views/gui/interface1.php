...
//                            console.log('Aqui', embElement.getSVGDocument().documentElement);
                              
                                
                                panZoom.pan({x:0,y:0});
                                var svgElement = embElement.getSVGDocument();
//                              console.log('parent: ',svgElement);
...
//                              console.log('position2: ',position);
    ...
    //                          console.log('>>position.lef: ', position.left);
    //                            console.log('>>WITH: ', jQuery('#' + idElement).width());
    //                            console.log('>>Height: ', jQuery('#' + idElement).height());
...
//                              panZoom.panBy({x: width / 2 - position.left, y: height / 2 - position.top});
                                ...
                                // panZoom.zoomAtPoint(2,{x: position.left , y: position.top + (height / 2)});
