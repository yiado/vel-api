...
<table border="0" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td  rowspan="2" width="25%" align="left">
            <img src="<?= base_url().$this->config->item('company_logo') ?>" >
        </td>  
    ...
    <tr>
        <td align="center">
            <img src="<?= base_url(); ?>temp/barcode_uchile_plancheta.jpg" wwidth="370">
        </td> 
    </tr>
</table>
...
<tr>
    <td>
                ...
                <tr>
                    <td><strong>C&oacute;digo Recinto </strong></td>
                    <td>: <?= $codigo_recinto; ?></td>    
                </tr>
                <tr>
...
<table width="100%" border="1" cellpadding="2" cellspacing="0">
  <tr>
    ...
    <td colspan="5" bgcolor="#cccccc"><div align="center"><strong>Bien de Registro</strong></div></td>
