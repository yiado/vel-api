    ...
    beforeShow : function(){
        ...
        if(this.modal){
			...
			if (Ext.isIE) {
				vp = document.body;
				// modal cover
				modalCoverI = document.createElement("IFRAME");
				modalCoverI.frameBorder = "0";
				modalCoverI.id = 'vp_iframe_window';
				modalCoverI.className = "dhx_modal_cover_ifr";
				modalCoverI.style.zIndex = 1000;
				vp.appendChild(modalCoverI);
			}
        }
    },
...
/**
    ...
    hide : function(animateTarget, cb, scope){
        ...
        if(this.modal){
            this.mask.hide();
			if (Ext.isIE) document.body.removeChild(document.getElementById('vp_iframe_window'));
