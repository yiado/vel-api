...
App.Document.TBar = {
    ...
    items: [App.ModuleActions[2001], {
        ...
        },
        {
            ...
            iconCls: 'img_icon',
            handler: function(b) {
                App.Document.Store.load({ params: { node_id: App.Interface.selectedNodeId, doc_category_id: 12 } });
            }
        }, {
            xtype: 'spacer',
            width: 10
...
App.Document.Version.Window = Ext.extend(Ext.Window, {
    title: App.Language.General.versions,
    width: (screen.width < 900) ? screen.width - 50 : 900,
    height: 410,
    modal: true,
    maximizable: true,
    resizable: false,
...
App.Document.editionNewVersion = function(record) {
    ...
    if (App.Security.Actions[2004] === undefined || App.Interface.permits === false) {
