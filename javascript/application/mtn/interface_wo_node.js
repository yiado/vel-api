                ...
                Ext.Ajax.request({
                    ...
                    success: function(response) {
                        ...
                        if (response.success == "true") {
                            ...
                            //                            Ext.MessageBox.confirm(App.Language.General.confirmation, "Debe agregarle un Proveedor mediante un contrato desea hacerlo ahora?", function(b) {
                            //                                if (b == 'yes')
                            //                                {
                            //                                    wacp = new App.Mtn.Wo.addContractProviderWindow();
                            //                                    wacp.show();
                            //                                    
                            //                                }
                            //                            });
