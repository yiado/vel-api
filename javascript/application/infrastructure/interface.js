...
//                                    html: '<object id="svg1" width="100%" height="100%" data="plans/base_1613.svg" type="image/svg+xml"></object>'
                ...
                xtype: 'grid', ref: 'grid', id: 'App.InfraStructure.Principal.Grid',
                ...
                xtype: 'form', ref: 'otherdata',
                anchor: '100%', labelWidth: 300,
...
App.InfraStructure.ActualizarDatosMasivoViewWindow = Ext.extend(Ext.Window,
        {
            ...
            initComponent: function ()
            {
                this.items =
                        [{
                                xtype: 'form', ref: 'form', fileUpload: true,
                                labelWidth: 150,
                                padding: 5,
                                items:
                                        [{
            ...
            initComponent: function ()
            {
                this.items =
                        [{
                                ...
                                xtype: 'grid', id: 'App.InfraStructure.FotoConfi.GridView',
                                region: 'west', layauot: 'fit',
                                width: 750,
...
{//--> ACA ENTRA AL HACER CLICK AL ARBOL <--
...
App.InfraStructure.addNodeWindow = Ext.extend(Ext.Window,
        {
            ...
            initComponent: function ()
            {
                this.items =
                        [{
                                xtype: 'form', title: App.Language.Infrastructure.simple_mode,
                                padding: 5,
                                autoHeight: true,
                                items:
                                        [{
...
//                                         
                                            },
                                            {
                                                ...
                                                hidden: true,
                                                cls: 'test_',
                                                anchor: '100%', store: App.NodeType.Store,
                                ...
                                xtype: 'form', title: App.Language.Infrastructure.advanced_mode,
                                autoHeight: true,
...
App.InfraStructure.exportListWindow = Ext.extend(Ext.Window,
        {
            ...
            initComponent: function ()
            {
                this.items =
                        [{
                                xtype: 'form', padding: 5,
                                items:
                                        [{
                                                xtype: 'textfield',
                                                fieldLabel: App.Language.General.file_name,
                                                anchor: '100%', name: 'file_name',
                                                maskRe: /^[a-zA-Z0-9_]/,
                                                regex: /^[a-zA-Z0-9_]/,
                                                allowBlank: false
                                            }, {
...
App.InfraStructure.searchWindow = Ext.extend(Ext.Window,
        {
            ...
            initComponent: function ()
            {
                this.items =
                        [{
                                xtype: 'form', ref: 'form', layout: 'border',
                                border: true,
                                items:
                                        [{
                                                xtype: 'tabpanel',
                                                ...
                                                items:
                                                        [{
                                                                xtype: 'grid', title: App.Language.Infrastructure.node_type,
                                                                columnWidth: 1,
                                                                ...
                                                                anchor: '100%', sm: new Ext.grid.CheckboxSelectionModel(),
                                                                viewConfig:
                                                                        {
                                                                            forceFit: true
                                                                        },
...
App.InfraStructure.emportListMasiva = Ext.extend(Ext.Window,
        {
            ...
            initComponent: function ()
            {
                this.items =
                        [{
                                xtype: 'form', ref: 'form', labelWidth: 150,
                                fileUpload: true,
                                plugins: [new Ext.ux.OOSubmit()],
                                padding: 5,
                                items:
