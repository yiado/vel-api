    ...
    initComponent: function()
    {
        ...
        [{
            ...
            [{
                ...
                text: "Finalizar COLLECT (Limpiar Tablas)",
                id: 'App.FinalizaCollect',
                iconCls: 'clean_icon',
                handler: function(b)
                {
                      Ext.MessageBox.confirm(App.Language.General.confirmation, 'Esta seguro de Vaciar las Tablas', function(b)
                      {
                          if (b == 'yes') 
                          {
                                var msg = Ext.MessageBox.wait('Favor esperar', 'Procesando inventario...');
                                Ext.Ajax.request
                                ({
...
{
    title: "Generar Reportes Masivos",
    width: 550,
    height: 300,
    layout: 'fit',
    modal: true,
    ...
    initComponent: function()
    {
        ...
        [{
                ...
                [{
                    ...
                    items:
                    [{
                        boxLabel: 'Generar reporte de Control de Inventario',
                        name: 'output_type',
                        inputValue: 'ct',
                        height: 25,
                        checked: true
                    }, {
                        boxLabel: 'Generar reporte de Faltantes',
                        name: 'output_type',
                        inputValue: 'cf',
                        height: 25
                    }, {
                        boxLabel: 'Generar reporte de Trasladados',
                        name: 'output_type',
                        inputValue: 'ctt',
                        height: 25
                    }, {
                        boxLabel: 'Generar reporte de no Registrados en IGEO',
                        name: 'output_type',
                        inputValue: 'canr',
                        height: 25
                    }, {
                        boxLabel: 'Generar reporte de Activos sin Cambios',
                        name: 'output_type',
                        inputValue: 'cc',
                        height: 25
                    }]
    ...
    initComponent: function()
    {
        ...
        [{
                ...
                [{
                    ...
                    xtype: 'displayfield',
                    fieldLabel: "Código Auge",
                    name: 'codigo_auge',
                    anchor: '100%'    
                    
                }, {
                    xtype: 'displayfield',
                    fieldLabel: "Ubicación Original",
                    name: 'original_location',
                    anchor: '100%'    
                    
                }, {
                    xtype: 'displayfield',
                    fieldLabel: "Departamento Original",
                    name: 'departamento_original',
                    anchor: '100%'    
                    
                }, {
                    xtype: 'displayfield',
                    fieldLabel: "Nombre Subrecinto Original",
                    name: 'nombre_subrecinto_original',
                    anchor: '100%'    
                    
                }, {
                    xtype: 'displayfield',
                    fieldLabel: "Ubicación de Traslado",
                    name: 'location_transfer',
                    anchor: '100%'    
                    
                }, {
                    xtype: 'displayfield',
                    fieldLabel: "Departamento de Traslado",
                    name: 'departamento_transfer',
                    anchor: '100%'    
                    
                }, {
                    xtype: 'displayfield',
                    fieldLabel: "Nombre Subrecinto de Traslado",
                        ...
                        ({
                            ...
                            success: function(form, response)
                            {
                                ...
                                ({
                                    callback: function()
                                    {
                                        Ext.FlashMessage.alert('Collect Cargado con Exito y Procesado... Selecione la Opción Generar Reportes');
                                    }
                                });
                                b.ownerCt.ownerCt.ownerCt.close();
                            },
